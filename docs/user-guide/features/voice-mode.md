...
For hands-free session start — saying "hey hermes" (or any phrase) to open a fresh voice session on the CLI, TUI, or desktop app — see [Wake Word](https://hermes-agent.nousresearch.com/docs/user-guide/features/wake-word).
