...
What stays per-profile and is *not* absorbed by the switcher: gateway processes (manage them via `hermes -p <name> gateway …`), each profile's session database, and cron schedulers (the Cron page already aggregates across profiles with its own filter).
...
![Config admin page — section filters on the left, auto-discovered fields on the right](https://hermes-agent.nousresearch.com/docs/assets/images/admin-config-278bd624188f3bfb9ec51a0b51767c6e.png)
...
![Sessions admin page — stats bar, prune, and per-row rename / export / delete](https://hermes-agent.nousresearch.com/docs/assets/images/admin-sessions-677424bf69f04266372c786d9e089215.png)
...
![Skills admin page — the Browse hub view: search, install, and update](https://hermes-agent.nousresearch.com/docs/assets/images/admin-skills-hub-28ba9342a928061ac63d5459bb6e8237.png)

### MCP

Manage [MCP](https://hermes-agent.nousresearch.com/docs/integrations/mcp) servers without the CLI. The same `mcp_servers` block in `config.yaml` that `hermes mcp` reads from.
...
![MCP admin page — your servers with enable/disable toggles, plus the install catalog](https://hermes-agent.nousresearch.com/docs/assets/images/admin-mcp-e1961a965758bea42fc5e0123ae669d5.png)

### Webhooks

Manage dynamic [webhook subscriptions](../messaging/webhooks.md). The webhook platform must be enabled in messaging settings first; the page shows a hint when it isn't.
...
![Webhooks admin page — subscriptions with enable/disable toggles](https://hermes-agent.nousresearch.com/docs/assets/images/admin-webhooks-c66b07d1921c57095bc24f84d809906b.png)
...
![Pairing admin page](https://hermes-agent.nousresearch.com/docs/assets/images/admin-pairing-f277738b95ac6fc088dc3c6a35b221fb.png)
...
![Channels admin page — every messaging platform with status, enable toggles, and per-platform setup forms](https://hermes-agent.nousresearch.com/docs/assets/images/admin-channels-a24702ec3e46c4e3f857f5f416e48ffd.png)
...
![System admin page — host stats and Nous Portal status](https://hermes-agent.nousresearch.com/docs/assets/images/admin-system-top-112b3d064967afbb7572481c7d431a9b.png)

![System admin page — skill curator, gateway, memory, and credential pool](https://hermes-agent.nousresearch.com/docs/assets/images/admin-system-curator-7d9002386f581d7a5397b077536c7b3e.png)

![System admin page — operations, checkpoints, and shell hooks](https://hermes-agent.nousresearch.com/docs/assets/images/admin-system-ops-27a440fc4e3fdff516bd1296d9471d51.png)

Creating a shell hook (note the consent checkbox and the run-arbitrary-commands warning):

![New shell hook modal](https://hermes-agent.nousresearch.com/docs/assets/images/admin-hook-create-8a01fb17b10ed3d0f488ee9f0f44c6a9.png)
...
To build your own theme, add a plugin tab, inject into shell slots, or expose plugin-specific REST endpoints, see **[Extending the Dashboard](extending-the-dashboard.md)** — the complete guide covers:
