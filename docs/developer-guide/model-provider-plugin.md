...
title: "Building a Model Provider Plugin"
...
See [Building a Hermes Plugin](plugins.md#distribute-via-pip) for the full entry-points setup.
...
- [Building a Hermes Plugin](plugins.md) — general plugin authoring
