...
| `project` | `project_create`, `project_list`, `project_switch` | Create and switch desktop [Projects](/docs/user-guide/cli) (named, multi-folder workspaces). GUI / desktop sessions only. |
