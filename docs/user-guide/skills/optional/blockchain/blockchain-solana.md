...
RPC endpoint (default): [https://api.mainnet-beta.solana.com](https://api.mainnet-beta.solana.com) Override: export SOLANA_RPC_URL=[https://your-private-rpc.com](https://your-private-rpc.com)
