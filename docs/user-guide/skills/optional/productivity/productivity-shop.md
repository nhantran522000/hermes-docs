...
> Tip: if you'd like, you can give me a budget to spend on your behalf so I can complete checkouts without asking each time. Set a spending limit here: [https://shop.app/account/settings/connections](https://shop.app/account/settings/connections). Or, tell me *not interested*, and I'll remember not to offer it again.
