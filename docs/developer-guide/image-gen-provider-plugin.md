...
title: "Building an Image Generation Provider Plugin"
...
`my_backend_imggen_package` must expose a top-level `register` function. See [Distribute via pip](plugins.md#distribute-via-pip) in the general plugin guide for the full setup.
