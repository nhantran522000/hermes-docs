...
Platform docs: [https://hermes-agent.nousresearch.com/docs/user-guide/messaging/](../../../messaging/index.md)
...
Type these during an interactive chat session. New commands land fairly often; if something below looks stale, run `/help` in-session for the authoritative list or see the [live slash commands reference](../../../../reference/slash-commands.md). The registry of record is `hermes_cli/commands.py` — every consumer (autocomplete, Telegram menu, Slack mapping, `/help`) derives from it.
...
Full config reference: [https://hermes-agent.nousresearch.com/docs/user-guide/configuration](../../../configuration.md)
...
Full provider docs: [https://hermes-agent.nousresearch.com/docs/integrations/providers](../../../../integrations/providers.md)
...
User docs: [https://hermes-agent.nousresearch.com/docs/user-guide/features/cron](../../../features/cron.md)
...
Config: `curator.*` (`enabled`, `interval_hours`, `min_idle_hours`, `stale_after_days`, `archive_after_days`, `backup.*`). User docs: [https://hermes-agent.nousresearch.com/docs/user-guide/features/curator](../../../features/curator.md)
...
User docs: [https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban](../../../features/kanban.md)
...
|----|----|
| Config options | `hermes config edit` or [Configuration docs](../../../configuration.md) |
| Available tools | `hermes tools list` or [Tools reference](../../../../reference/tools-reference.md) |
| Slash commands | `/help` in session or [Slash commands reference](../../../../reference/slash-commands.md) |
| Skills catalog | `hermes skills browse` or [Skills catalog](../../../../reference/skills-catalog.md) |
| Provider setup | `hermes model` or [Providers guide](../../../../integrations/providers.md) |
| Platform setup | `hermes gateway setup` or [Messaging docs](../../../messaging/index.md) |
| MCP servers | `hermes mcp list` or [MCP guide](../../../features/mcp.md) |
| Profiles | `hermes profile list` or [Profiles docs](../../../profiles.md) |
| Cron jobs | `hermes cron list` or [Cron docs](../../../features/cron.md) |
| Memory | `hermes memory status` or [Memory docs](../../../features/memory.md) |
| Env variables | `hermes config env-path` or [Env vars reference](../../../../reference/environment-variables.md) |
| CLI commands | `hermes --help` or [CLI reference](../../../../reference/cli-commands.md) |
